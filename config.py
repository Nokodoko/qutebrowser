...
c.bindings.key_mappings = {'<Ctrl-[>': '<Escape>', '<Ctrl-6>': '<Ctrl-^>', '<Ctrl-M>': '<Return>', '<Ctrl-J>': '<Return>',
                           '<Ctrl-I>': '<Tab>', '<Shift-Return>': '<Return>', '<Enter>': '<Return>', '<Shift-Enter>': '<Return>', '<Ctrl-Enter>': '<Ctrl-Return>'}
...
## Type: Font
c.fonts.completion.category = 'bold default_size VictorMono'

# Font used in the completion widget.
## Type: Font
c.fonts.completion.entry = 'default_size VictorMono'
...
# Default font families to use. Whenever "VictorMono" is used in a
...
## Type: Font
c.fonts.downloads = 'default_size VictorMono'

# Font used for the hints.
## Type: Font
c.fonts.hints = 'bold default_size VictorMono'

# Font used in the keyhint widget.
## Type: Font
c.fonts.keyhint = 'default_size VictorMono'

# Font used for error messages.
## Type: Font
c.fonts.messages.error = 'default_size VictorMono'

# Font used for info messages.
## Type: Font
c.fonts.messages.info = 'default_size VictorMono'

# Font used for warning messages.
## Type: Font
c.fonts.messages.warning = 'default_size VictorMono'
...
## Type: Font
c.fonts.statusbar = 'default_size VictorMono'
...
# hints.
## Type: Dict
c.hints.selectors = {'all': ['a', 'area', 'textarea', 'select', 'input:not([type="hidden"])', 'button', 'frame', 'iframe', 'img', 'link', 'summary', '[onclick]', '[onmousedown]', '[role="link"]', '[role="option"]', '[role="button"]', '[ng-click]', '[ngClick]', '[data-ng-click]', '[x-ng-click]', '[tabindex]'], 'links': ['a[href]', 'area[href]', 'link[href]', '[role="link"][href]'], 'images': [
    'img'], 'media': ['audio', 'img', 'video'], 'url': ['[src]', '[href]'], 'inputs': ['input[type="text"]', 'input[type="date"]', 'input[type="datetime-local"]', 'input[type="email"]', 'input[type="month"]', 'input[type="number"]', 'input[type="password"]', 'input[type="search"]', 'input[type="tel"]', 'input[type="time"]', 'input[type="url"]', 'input[type="week"]', 'input:not([type])', 'textarea']}
...
c.url.searchengines = {
    ...
    'tb':      'https://www.youtube.com/results?search_query={}',
    'god':     'https://www.godoc.org/?q={}',
    'go':      'https://www.golang.org/search?q={}',
    'gpack':   'https://www.golang.org/pkg/{}',
...
# '!tb': 'https://youtube.com/results?search_query={}'
# '!aw': 'https://wiki.archlinux.org/?search={}'
# }
...
# SITES
config.bind('!w', 'open -t https://wallhaven.cc/')
config.bind(
    '!gd', 'open -t https://dashboard.godaddy.com/venture?ventureId=0dba776d-c5bd-4415-aa52-1fa27206e9e7')
config.bind('!ca', 'open -t https://api.capacity.com/static/docs.html')
config.bind('!p', 'open -t https://prometheus.capacity.com/alerts')
config.bind('!s', 'open -t https://dwm.suckless.org/patches/')
config.bind('!gh', 'open -t github.com')
config.bind('!l', 'open -t linkedin.com')
config.bind('!y', 'open -t youtube.com')
config.bind('!r', 'open -t reddit.com')
config.bind('!m', 'open -t gmail.com')
config.bind('!a', 'open -t wiki.archlinux.org')
config.bind('!G', 'open -t https://tutorialedge.net/course/golang/')
config.bind('!t', 'open -t twitter.com')
config.bind('!u', 'open -t udemy.com')
config.bind('al', 'open -t https://courses.ardanlabs.com/users/sign_in')
config.bind('!q', 'open -t https://www.qutebrowser.org')
config.bind('!;', 'open -t https://www.shortcutfoo.com/app/dojos/qutebrowser')
config.bind('!e', 'open -t https://www.ebay.com')
config.bind('!k', 'open -t https://sw.kovidgoyal.net/kitty')
config.bind('!3', 'open -t https://www.353solutions.com/c/al-rest/')
config.bind('ag', 'open -t https://www.godoc.org')
config.bind('!v', 'open -t https://vimawesome.com/?p=2&q=cat%3Alanguage')
config.bind('!gc', 'open -t https://courses.calhoun.io/courses/cor_gophercises')
config.bind('!d', 'open -t https://app.datadoghq.com/dashboard/lists')
config.bind(
    '!t', 'open -t https://registry.terraform.io/providers/hashicorp/aws/latest/docs')
config.bind('!o', 'open -t https://www.overleaf.com/learn')
config.bind(
    '!x', 'open -t http://ctan.math.utah.edu/ctan/tex-archive/info/latex2e-help-texinfo/latex2e.html')
config.bind('!6', 'open -t https://www.r6-forum.com/')
config.bind(
    '!ws', 'open -t https://docs.aws.amazon.com/cloudshell/latest/userguide/welcome.html')
config.bind(
    '!ja', 'open -t https://equity.atlassian.net/jira/software/c/projects/OPS/boards/210')
config.bind(
    '!jA', 'open -t https://equity.atlassian.net/jira/settings/projects/manage')
config.bind('!gl', 'open -t https://gitlab.aisoftware.com/')
config.bind('!cf', 'open -t https://equity.atlassian.net/wiki/home')

config.bind(
    '!8', 'open -t https://2020-05-ardan.container.training/k8s-bootcamp.yml.html#1')
# Bindings for normal mode
config.bind('Fc', 'config-cycle tabs.show always never')
config.bind('Fb', 'config-cycle statusbar.hide')
config.bind('Fx', 'set tabs.show always;; later 5000 set tabs.show switching')
...
config.bind(
    '<Up>', 'hint links spawn --detach mpv --force-window yes {hint-url}')
